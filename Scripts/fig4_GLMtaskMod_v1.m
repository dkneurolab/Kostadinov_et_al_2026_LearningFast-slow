function fig4_GLMtaskMod_v1(sessions,pcaVar, dataFold, paperFold, savebool)
...
%     xvalFold = setFiles.inits.xvalfold;
    ...
    fig4_GLMtaskMod_v1_makeDM(trialBasis,setFiles.inits,trialOutcomes,glmFold,savebool);
end
