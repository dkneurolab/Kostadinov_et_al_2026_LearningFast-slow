function matchData = fig2_matchedROIs_vs_days(dataFold,paperFold,matchColors,savebool)
...
if savebool
    ...
    print(figout,fullfile(figFold,[figname,'.eps']), '-depsc', '-vector');
    matchROIs = matchData;
    ...
    print(figout,fullfile(figFold2,[figname,'.eps']), '-depsc', '-vector');
